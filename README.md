...
64 bytes from 8.8.8.8: icmp_seq=1 ttl=63 time=53.1 ms
^C
...
64 bytes from 192.168.0.2: icmp_seq=2 ttl=63 time=0.806 ms
^C
...
1 packets transmitted, 1 received, 0% packet loss, time 2034ms
```
